...
import me.linyujie.mydribbbo.model.Like;
...
public class Dribbble {
    ...
    // parse the response (from Json Format) to target format
    ...
    //initialization, get the accessToken
    ...
    // login, use the accessToken to retrived user information from API
    ...
    public static Bucket newBucket(@NonNull String name, @NonNull String description) throws DribbbleException {
        FormBody formBody = new FormBody.Builder()
                    .add(KEY_NAME, name)
                    .add(KEY_DESCRIPTION, description)
                    .build();
        Response response = makePostRequest(BUCKETS_END_POINT, formBody);
        return parseResponse(response, BUCKET_TYPE);
    }

    public static void addBucketShot(@NonNull String bucketId, @NonNull String shotId) throws DribbbleException {
    ...
    public static void removeBucketShot(@NonNull String bucketId, @NonNull String shotId) throws DribbbleException {
        String url = BUCKETS_END_POINT + "/" + bucketId + "/shots";
        FormBody formBody = new FormBody.Builder()
                .add(KEY_SHOT_ID, shotId)
                .build();
