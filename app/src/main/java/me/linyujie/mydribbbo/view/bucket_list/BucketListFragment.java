...
import me.linyujie.mydribbbo.view.base.DribbbleTask;
...
public class BucketListFragment extends Fragment {
    ...
    private InfiniteAdapter.LoadMoreListener onLoadMore = new InfiniteAdapter.LoadMoreListener() {
        ...
        public void onLoadMore() {
            // async task
            new LoadBucketTask(false).execute();
        }
    };

    public static BucketListFragment newInstance(@Nullable String userId, boolean isChoosingMode, @Nullable ArrayList<String> chosenBucketIds) {
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        swipeRefreshLayout.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                // async task;
                new LoadBucketTask(true).execute();
            }
        });
